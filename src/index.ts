...
export const getAstrDomainSDK = async (
	options?: ConfigType
): Promise<AstarDomainSDK> => {
	const _config = options || defaultConfig;

	const { rpcUrl, contractAddress } =
		_config.defaultNetwork == 'mainnet' ? _config.mainnet : _config.testnet;
	...
	const signer = provider.getSigner(
		'0x5be02bCFE218f33DD7Fa93EBb5791e925ae7b473'
	);
